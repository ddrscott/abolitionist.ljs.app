...
Pan and zoom to explore. Each **"Read:"** rectangle is clickable and opens the article that addresses that specific sticking point. Start at the top — *Ask the Abolitionist* — and follow the YES/NO arrows down until you find the question you can't honestly answer *no* to. That's your place in the corpus.

<ExcalidrawViewer client:only="react" />
